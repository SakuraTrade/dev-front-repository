        ...
        <section className="w-full my-4 flex place-content-between items-baseline">
          ...
          <div className="flex gap-2 items-baseline">
            <span className=" px-2 border-r-1">
              총 수량
              <strong className="text-green-500">{userQuantity}</strong>개
            </span>
          ...
          <section className="my-4 w-full flex gap-2">
            {favorite ? (
              <button
                ...
                className="flex border border-gray-300 p-4 bg-amber-100 text-pink-600 rounded-sm items-center cursor-pointer"
              >
                <GoHeartFill />
              </button>
            ) : (
